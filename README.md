# Awesome Angular 2+ Libraries and Tools 🚀
...
1. [Design, Layout, and Animations 🎨](#design-layout-and-animations)  
2. [Audio and Video 🎵📹](#audio-and-video)  
3. [Image Lazy Loading 🖼️](#image-lazy-loading)  
4. [Maps 🗺️](#maps)  
5. [Various Modules 🛠️](#various-modules)  
6. [Starter Projects 🚀](#starter-projects)  
7. [UI Component Libraries 🖌️](#ui-component-libraries)  
8. [Standalone UI Components 🧩](#standalone-ui-components)  
9. [Input Components 🎛️](#input-components)  
10. [API and Data Layer 🔗](#api-and-data-layer)  
11. [State Management 📊](#state-management)  
12. [Internationalization 🌐](#internationalization)  
13. [Authentication 🔒](#authentication)  
14. [Messages/Notifications 📢](#messages-notifications)  
15. [Drag & Drop 📂](#drag--drop)  
16. [Local Storage 📥](#local-storage)  
17. [Data Table Components 📋](#data-table-components)  
18. [Forms 📝](#forms)  
19. [Hot Module Loader 🔄](#hot-module-loader)  
20. [Loading Indicators/Spinners ⏳](#loading-indicatorsspinners)  
21. [Charts 📈](#charts)  
22. [Tools 🔧](#tools)  
